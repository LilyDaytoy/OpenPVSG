...
class Mask2FormerVideoHeadSplit(MaskFormerVideoHead):
    ...
    def __init__(self,
        ...
        self.thing_cls_embed = nn.Linear(feat_channels, self.num_things_classes)
        self.stuff_cls_embed = nn.Linear(feat_channels, self.num_stuff_classes)
